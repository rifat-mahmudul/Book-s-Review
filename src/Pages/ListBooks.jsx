    ...
    return (
        <div className="max-w-[90%] xl:max-w-[1200px] mx-auto">
            ...
            <div className={`flex items-center overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap`}>
                <Link onClick={()=>setIndex(0)} className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 rounded-t-lg border-black ${index === 0 ? 'border-2 border-b-0 ' : 'border-b-2'}`}>
                ...
                <Link onClick={()=>setIndex(1)} className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 rounded-t-lg border-black ${index === 1 ? 'border-2 border-b-0 ' : 'border-b-2'}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
